 ...
 *
 */
public class GoibiboSiteStepDefinitions extends GoibiboSiteTest {
	...
	public void user_verify_Goibibo_home_page_title() throws Exception {
		goibiboSiteTest.verifyHomePageTitle();
	}
